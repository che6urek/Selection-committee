...
import com.by.evgeny.selection.committee.command.input.EntryField;
...
public class AddEnrolle implements Command {
    ...
    public void execute() {
        ...
        SingletonEnrollees.getInstance().add(new Enrolle(new PersonalData(name, surname, patronymic),
